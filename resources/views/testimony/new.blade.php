...
@section('content')
    <div class="container-fluid">
        <fieldset class="border p-2" style="text-align: right">
            <legend class="w-auto"><small class="font-weight-bold"> add a testimony</small> </legend>
            <div class="d-flex justify-content-center">
                <div class="col-md-6 col-sm-6">
                    <fieldset class="border p-2" style="text-align: right">
                        <legend class="w-auto"><small>create testimony</small></legend>
                            {!! Form::open(['method' => 'POST', 'action' => 'TestimonyController@store',
                            'enctype' => 'multipart/form-data']) !!}
                                <div class="row form-group">
                                    {!! Form::label('name', ('Name'), ['class' => 'col-md-3 col-sm-3']) !!}
                                    {!! Form::text('name','',['class' => 'col-md-8 col-sm-8 form-control']) !!}
                                </div>
                                <div class="row form-group">
                                    {!! Form::label('email', ('Email'), ['class' => 'col-md-3 col-sm-3']) !!}
                                    {!! Form::text('email','',['class' => 'col-md-8 col-sm-8 form-control']) !!}
                                </div>
                                <div class="row form-group">
                                ...
                                <div class="row form-group">
                                    ...
                                    {!! Form::textarea('comment','',['class' => 'col-md-8 col-sm-8 form-control', 'rows' => '3']) !!}
                                </div>
                                <div class="row form-group">
