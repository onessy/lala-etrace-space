...
@section('content')
    <div class="container-fluid">
        <fieldset class="border p-2" style="text-align: right">
            <legend class="w-auto"><small class="font-weight-bold">Add news & updates</small> </legend>
            <div class="d-flex justify-content-center">
                <div class="col-md-6 col-sm-6">
            <fieldset class="border p-2" style="text-align: right">
                <legend class="w-auto"><small class="font-weight-bold">create news and updates</small> </legend>
                ...
                {!! Form::text('headline','',['class' => 'form-control col-md-8 col-sm-8 text-capitalize']) !!}
                </div>
                <div class="row form-group">
                    {!! Form::label('type',('Category'),['class' => 'col-md-3 col-sm-3']) !!}
                    {!! Form::select('type',['News' => 'News', 'Updates' => 'Updates'],'',
                    ['class' => 'form-control col-md-8 col-sm-8', 'placeholder' => '--select--']) !!}
                </div>
                <div class="row form-group">
                    {!! Form::label('news',('Information'),['class' => 'col-md-3 col-sm-3']) !!}
                    {!! Form::textarea('news','',['class' => 'form-control col-md-8 col-sm-8', 'rows' => '3']) !!}
                </div>
                <div class="row form-group">
                ...
                <div class="row mb-0 form-group">
                    <button type="submit" class="btn btn-sm btn-success offset-md-3">@fas('save') news</button>
                </div>
                {!! Form::close() !!}
            </fieldset>
                </div>
